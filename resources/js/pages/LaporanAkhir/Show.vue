...
function ShowArsip(tugasId: number) {
    router.visit(`/arsip-monitoring/detail/${tugasId}`);
}
...
<template>
    <Head title="Detail Arsip Monitoring Perangkat Daerah" />
        ...
        <div class="flex flex-col gap-4 p-4">
            ...
            <div class="rounded-lg bg-white p-6 shadow-lg border border-gray-100">
                <div class="flex items-center mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-gray-600">Arsip Monitoring - Detail Perangkat Daerah</h2>
                </div>
            ...
            <div class="mt-6 rounded-lg bg-white p-6 shadow-md">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">Daftar Tugas Perangkat Daerah</h3>
                            ...
                            <tr v-for="tugas in urusanTugas" :key="tugas.id">
                                ...
                                <td class="border px-4 py-2 w-32">
                                    <div class="flex justify-center">
                                        <button
                                            class="flex items-center justify-center bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-medium px-3 py-1 rounded"

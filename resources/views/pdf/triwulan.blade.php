                ...
                @foreach ($programsInBidang as $program)
                    ...
                    @foreach ($kegiatanInProgram as $kegiatan)
                        ...
                        <tr style="background-color: #f8fcff; font-weight: bold;">
                            ...
                            <td class="center"><strong>{{ number_format($avgKegiatanRealisasiFisik, 1) }}%</strong>
                            </td>
                            <td class="center">
        ...
        <div class="summary-box">
            ...
            <div class="summary-item">
                ...
                <span>Rp {{ number_format($totalRealisasiKeuangan, 0, ',', '.') }}
                    ({{ $totalPagu > 0 ? number_format(($totalRealisasiKeuangan / $totalPagu) * 100, 2) : '0.00' }}%)</span>
            </div>
    ...
    <div class="signature-section">
        <div class="signature-box">
            <p>{{ $penandatangan_1['tempat'] }},
                {{ \Carbon\Carbon::parse($penandatangan_1['tanggal'])->format('d F Y') }}</p>

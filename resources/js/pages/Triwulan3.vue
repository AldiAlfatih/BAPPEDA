...
const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Monitoring Triwulan 3', href: route('triwulan.index', { tid: 3 }) },
];
...
function goToShowPage(id: number) {
  router.visit(route('triwulan.show', { tid: 3, id }));
}
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex flex-col gap-6 p-6">
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Monitoring Triwulan 3</h1>

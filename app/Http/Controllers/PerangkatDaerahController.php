...
class PerangkatDaerahController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('PerangkatDaerah')->with('success', 'Data SKPD berhasil disimpan.');
    }
   ...
   public function show(string $id)
   {
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('PerangkatDaerah')->with('success', 'Data SKPD berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('PerangkatDaerah')->with('success', 'Data SKPD berhasil dihapus.');
    }
}